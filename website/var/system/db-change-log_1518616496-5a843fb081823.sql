...
ALTER TABLE `object_query_1` ADD COLUMN `description` longtext NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` ADD COLUMN `description` longtext NULL;
...
ALTER TABLE `object_query_1` ADD COLUMN `picture` int(11) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` ADD COLUMN `picture` int(11) NULL;
...
ALTER TABLE `object_query_1` ADD COLUMN `categoryid` double NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` ADD COLUMN `categoryid` double NULL;
...
ALTER TABLE `object_query_1` ADD COLUMN `price` double NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` ADD COLUMN `price` double NULL;
...
ALTER TABLE `object_query_1` ADD COLUMN `modified_datetime` bigint(20) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` ADD COLUMN `modified_datetime` bigint(20) NULL;
...
ALTER TABLE `object_query_1` ADD COLUMN `currencyId` double NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` ADD COLUMN `currencyId` double NULL;
...
ALTER TABLE `object_query_1` DROP COLUMN `attributes`;
