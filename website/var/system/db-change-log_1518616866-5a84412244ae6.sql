...
ALTER TABLE `object_query_1` CHANGE COLUMN `brand_name` `brand_name` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` CHANGE COLUMN `brand_name` `brand_name` varchar(190) NULL;
