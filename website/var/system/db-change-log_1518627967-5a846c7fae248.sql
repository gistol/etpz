...
ALTER TABLE `object_query_1` CHANGE COLUMN `currencyId` `currencyId` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` CHANGE COLUMN `currencyId` `currencyId` varchar(190) NULL;
