...
ALTER TABLE `object_query_1` ADD COLUMN `xmlproductid` double NULL;

/*--NEXT--*/

ALTER TABLE `object_store_1` ADD COLUMN `xmlproductid` double NULL;

/*--NEXT--*/

ALTER TABLE `object_query_1` DROP INDEX `p_index_xmlproductid`;

/*--NEXT--*/

ALTER TABLE `object_store_1` DROP INDEX `p_index_xmlproductid`;
