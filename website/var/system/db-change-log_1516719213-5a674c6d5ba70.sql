...
ALTER TABLE `object_query_7` ADD COLUMN `product_attribute_related_to_Collection` text NULL;

/*--NEXT--*/

ALTER TABLE `object_query_7` DROP INDEX `p_index_product_attribute_related_to_Collection`;

/*--NEXT--*/

ALTER TABLE `object_store_7` DROP INDEX `p_index_product_attribute_related_to_Collection`;
