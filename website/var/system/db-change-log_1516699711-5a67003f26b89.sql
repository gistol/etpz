...
ALTER TABLE `object_query_7` ADD COLUMN `val` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_7` ADD COLUMN `val` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_7` DROP INDEX `p_index_val`;

/*--NEXT--*/

ALTER TABLE `object_store_7` DROP INDEX `p_index_val`;

/*--NEXT--*/

ALTER TABLE `object_query_7` ADD COLUMN `parentkey` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_7` ADD COLUMN `parentkey` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_7` DROP INDEX `p_index_parentkey`;

/*--NEXT--*/

ALTER TABLE `object_store_7` DROP INDEX `p_index_parentkey`;

/*--NEXT--*/

ALTER TABLE `object_query_7` ADD COLUMN `valnum` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_7` ADD COLUMN `valnum` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_7` DROP INDEX `p_index_valnum`;

/*--NEXT--*/

ALTER TABLE `object_store_7` DROP INDEX `p_index_valnum`;

/*--NEXT--*/

ALTER TABLE `object_query_7` ADD COLUMN `option` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_7` ADD COLUMN `option` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_7` DROP INDEX `p_index_option`;

/*--NEXT--*/

ALTER TABLE `object_store_7` DROP INDEX `p_index_option`;
