...
ALTER TABLE `object_query_6` ADD COLUMN `name` varchar(190) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_6` ADD COLUMN `name` varchar(190) NULL;
...
ALTER TABLE `object_query_6` ADD COLUMN `related_cat_attributes_to_collection` text NULL;
...
ALTER TABLE `object_query_6` ADD COLUMN `related_attributes_to_collection` text NULL;
